...
def populate_main_window(frm_main):
    ...
    lbl_age = tk.Label(frm_main, text="Raio:")
    

    # Create a integer entry box where the user will enter her age.
    ent_raio = numy.IntEntry(frm_main, 1, 90, width=5)
    ...
    ent_raio.grid(  row=0, column=1, padx=3, pady=3)
