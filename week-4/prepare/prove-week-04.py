...
def draw_scene(canvas, scene_left, scene_top, scene_right, scene_bottom):
    ...
    draw_lawn(canvas,100, 400)
    draw_lawn(canvas,500, 400)
    draw_lawn(canvas,750, 400)
   ...
   # draw_grid(canvas, scene_left, scene_top, scene_right, scene_bottom, 100)
    ...
    draw_pine_tree(canvas, 400, 300, 150)
    draw_pine_tree(canvas, 630, 300, 150)
    draw_pine_tree(canvas, 500, 300, 150)
    draw_pine_tree(canvas, 600, 300, 150)
    draw_pine_tree(canvas, 350, 300, 150)
    draw_pine_tree(canvas, 230, 300, 150)
    draw_pine_tree(canvas, 150, 300, 150)
    draw_pine_tree(canvas, 130, 300, 150)
    ...
    draw_lawn(canvas,750, 450)
    draw_lawn(canvas,100, 450)
    
    
    draw_gram(canvas, 100, 450)
    draw_gram(canvas, 110, 450)
    draw_gram(canvas, 100, 450)
    draw_gram(canvas, 100, 450)
    draw_gram(canvas, 100, 450)
    draw_gram(canvas, 100, 450)
...
def draw_lawn(canvas, lawn_left, lawn_top):
    ...
    canvas.create_line(lawn_left, lawn_top, lawn_bottom, lawn_top,  fill="sienna4")

def draw_gram(canvas, gram_left, gram_top):

    gram_width = 50
    gram_higth = 5
   # gram_right =  gram_left + gram_width
    #gram_bottom = gram_top + gram_higth
    count = 10

    canvas.create_line(gram_left, gram_top, gram_left + 1, gram_top -9,  fill="green4")
main()    